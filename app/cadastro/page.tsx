    ...
    <Card className=" justify-center mx-auto w-100 h-100 max-w-md bg-green-800 border-none flex flex-col items-center p-4 ">
      <form className="flex flex-col gap-5">
        ...
        <h1 className="text-2xl text-white font-extrabold text-center">Seja bem vindo </h1>
         ...
         <Input className="w-70 placeholder:text-white"  placeholder="Nome" />
          ...
          <Button  className="w-70 h-10 cursor-pointer  backdrop-grayscale justify-center bg-white text-green-800 font-extrabold ">Cadastre-se</Button>
      </form>
    </Card>
    </div>
  )
